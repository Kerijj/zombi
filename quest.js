...
const QUEST_STEPS = {
    // === СТАРТ И ВЫБОР ВЕТКИ ===
    start: {
        text: `Ты приходишь в себя в полуразрушенном ангаре. Имплант активирован, но сигнал слабый: '120 MINUTES TILL DAWN'. Твоя цель — Бункер "Аврора". Ты должен выбрать маршрут.`,
        choices: [
            { text: "➡️ Ветка А: Через Заброшенную Лабораторию 'Генезис' (Путь Опасности)", next: "lab_start_scenario" },
            { text: "⬅️ Ветка В: Через Подземный Паркинг 'Катализатор' (Путь Ресурсов)", next: "parking_start_scenario" }
        ]
    },
    ...
    lab_start_scenario: {
        text: `
            ### 🔬 СЦЕНАРИЙ МИССИИ: ЛАБОРАТОРИЯ "ГЕНЕЗИС"
    ...
    parking_start_scenario: {
        text: `
            ### 🅿️ СЦЕНАРИЙ МИССИИ: ПАРКИНГ "КАТАЛИЗАТОР"
            Паркинг — это более длинный, но менее зараженный путь. Он завален обломками и полон ловушек выживших.
            **Твоя задача:** Найти путь через завалы и собрать топливо, чтобы пробить тяжелую дверь в Административный Зал.
            **Риски:** Временные задержки, ловушки, патрули выживших.
        `,
        choices: [{ text: "Начать: Зона 1 (Расчистка завала)", next: "parking_task_1" }]
    },
    parking_task_1: {
        text: `Зона 1: **Логика**. Я всегда на полу, но никогда не поднимаюсь. Что я? (Ответ: Тень)`,
        type: 'logic_puzzle',
        correctAnswer: 'тень', 
        successNext: 'parking_task_2' 
    },
    parking_task_2: {
        text: `Зона 2: **Моральная Дилемма**. Вы видите ящик с топливом. Взять (+2 минуты) или оставить для тех, кто ищет спасение?`,
        type: 'decision_scenario',
        choices: [
    ...
    parking_task_3: {
        text: `Зона 3: **Факт**. Верно ли, что зараженные боятся огня?`,
        type: 'believe',
        correctAnswer: true,
        successNext: 'parking_task_4'
    },
    parking_task_4: {
        text: `Зона 4: **Скорость**. Завал расчищен, но дверь начинает закрываться! 8 секунд на то, чтобы проскочить.`,
        type: 'speed_quiz',
        time: 8,
    ...
    parking_task_5: {
        text: `Зона 5: **Загадка**. Я могу быть белым или черным, но я всегда неверный. Что я? (Ответ: Свет)`,
        type: 'logic_puzzle',
        correctAnswer: 'свет', 
        successNext: 'parking_task_6'
    },
    parking_task_6: {
        text: `Зона 6: **Риск**. Вы нашли пробитую шину. Можно починить (+1 Чип), но это займет 5 минут.`,
        type: 'decision_scenario',
        choices: [
    ...
    parking_task_7: {
        text: `Зона 7: **Скрытая ловушка**. Ввод кода, где 'К=1, А=2, Т=3'. Введите 2. (Ответ: А)`,
        type: 'logic_puzzle',
        correctAnswer: 'а',
        successNext: 'parking_task_8'
    },
    parking_task_8: {
        text: `Зона 8: **Дилемма Чипов**. Для взлома системы контроля доступа нужен 1 Чип или 3 минуты.`,
        type: 'decision_scenario',
        choices: [
    ...
    parking_task_9: {
        text: `Зона 9: **Загадка**. Что имеет шею, но не имеет головы? (Ответ: Бутылка)`,
        type: 'logic_puzzle',
        correctAnswer: 'бутылка',
        successNext: 'parking_task_10'
    },
    parking_task_10: {
        text: `Зона 10: **Финальный Замок**. Какое слово написано неверно? (Ответ: Неверно)`,
        type: 'logic_puzzle',
    ...
    hall_start_scenario: {
        text: `
            ### 🏛️ СЦЕНАРИЙ МИССИИ: АДМИНИСТРАТИВНЫЙ ЗАЛ
            Вы вошли в Административный Зал. Громадные колонны и тишина. Это перекресток.
            **Твоя задача:** Взломать центральный сервер, чтобы найти кратчайший путь к Центральному Хранилищу Ресурсов (Локация 3).
            **Риски:** Автоматическая защита, патрули дронов.
        `,
